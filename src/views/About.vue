  ...
  <layout-default>
    <div class="Home">
      <h2 class="display-2 font-weight-light">
        Добро пожаловать на сайт навигатора по библиотекам
        <br />МАУ ЦБС г. Улан-Удэ!
      </h2>
      <p class="mx-auto mt-5">
        Здесь вы можете начать свое знакомство с возможностями, которые открывают для вас городские библиотеки.
        В Улан-Удэ 18 городских библиотек, в которых рады каждому.
        Централизованная библиотечная система
        состоит из Центральной городской библиотеки
        и 17 библиотек-филиалов.
      </p>
    </div>

    <v-row class="text-justify mx-auto mt-10">
      <v-col cols="1"></v-col>
    ...
    <v-row class="text-justify mx-auto mt-10">
      <v-col cols="1"></v-col>
      <v-col cols="4" class="text-left">
        <h3 class="display-1 font-weight-light"></h3>
      </v-col>
      <v-col
        cols="1"
