<template>
  <div class="about-page">
    ...
    <blockquote class="blockquote">
      <p>
        Здесь вы можете начать свое знакомство с возможностями, которые открывают для вас городские библиотеки МАУ ЦБС.
        Централизованная библиотечная система (МАУ ЦБС г. Улан-Удэ)
        <br />это сеть библиотек города Улан-Удэ, объединяющая Центральную городскую библиотеку
        и семнадцать библиотек-филиалов.
      </p>
    </blockquote>
    ...
    <!--
      ...
      <v-row class="text-justify mx-auto mt-10" justify="center">
        <v-col cols="12" md="4" class="text-left">
          <h3 class="display-1 font-weight-light">В библиотеках МАУ ЦБС вы найдете</h3>
        </v-col>
        <v-col
          cols="1"
        ...
        <v-col
          offset-md="4"
          cols="1"
          style=" background:no-repeat url(http://cbs-uu.ru/data/images/2.svg) 50% 30%;"
        ></v-col>
        <v-col cols="11" md="4">
        ...
        <v-col
          offset-md="4"
          cols="1"
          style=" background:no-repeat url(http://cbs-uu.ru/data/images/3.svg) 50% 30%;"
        ></v-col>
        <v-col cols="11" md="4">
        ...
        <v-col
          offset-md="4"
          cols="1"
          style=" background:no-repeat url(http://cbs-uu.ru/data/images/4.svg) 50% 30%;"
        ></v-col>
        <v-col cols="11" md="4">
  ...
  data() {
    return {
      items: [
        ...
        {
          src: "http://cbs-uu.ru/data/assets/places/2.jpg"
        },
        {
          src: "http://cbs-uu.ru/data/assets/places/5.jpg"
        }
      ]
    };
  },
