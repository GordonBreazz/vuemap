        ...
        placemarks: [
            {
                ...
                itinerary: {
                    ...
                    bus: '28, 120, 129',
                    tram: '1, 2, 4',
                    taxiBus: '2, 2а, 15, 30, 33, 37, 77, 80, 82, 92, 95, 97, 125, 131, 133, 134, 135, 161'
                },
                chief: {
                    title: 'Директор',
                ...
                clubs: ['«ЛИК» - организация встреч с писателями, краеведами, творческой интеллигенцией города']
            },
            {
            ...
            },
            {
                ...
                structure: ['Детский абонемент;',
                    ...
                    'Игровая комната',
                    'Отдел для чтения'],
                clubs: ['«Меридиан» - клуб для подростков с ограниченными воз-можностями здоровья',
            ...
            },
            {
                ...
                itinerary: {
                    ...
                    tram: '1, 2, 4',
                    taxiBus: '3, 25, 29, 30, 31, 37, 40, 46, 51, 54, 55, 56, 59, 64, 95, 97, 128, 132, 133, 177'
                },
                chief: {
                    title: '',
            ...
            },
            {
                ...
                structure: ['Абонемент',
                    ...
                    'Event room'],
                clubs: ['Объединения и клубы	«Оптимист» - клуб досуга для пенсионеров',
            ...
            },
            {
                ...
                structure: ['Абонемент',
                    ...
                    'Зал для мероприятий',
                    'Учебно-консультационный пункт ГО и ЧС'],
                clubs: ['«Fire fox» - клуб любителей культуры Востока',
            ...
            },
            {
                ...
                shedule: 2,
                structure: ['Абонемент', 'Читальный зал'],
                clubs: ['«Родник» - клуб досуга для пенсионеров',
            ...
            },
            {
                ...
                libraryType: 'Детская',
                shedule: 6,
                structure: ['Младший абонемент',
                    'Старший абонемент',
                    'Читальный зал с интерактивным оборудованием',
                    'Игровая зона'],
                clubs: ['«Хрусталики» - вокальный кружок для детей и подростков',
            ...
            },
            {
                ...
                libraryType: 'Универсальная',
                shedule: 0,
                structure: ['Абонемент для взрослых',
                    'Абонемент для детей',
                    'Читальный зал',
                    'Учебно-консультационный пункт ГО и ЧС',
                    'Мемориальный уголок К.Г. Карнышева'],
                clubs: ['«Олимп» - литературно-музыкальное объединение',
            ...
            },
            {
                ...
                shedule: 2,
                structure: ['Абонемент', 'Читальный зал'],
                clubs: ['Клуб семейного чтения «Мама и малыш»',
            ...
            },
            {
                ...
                libraryType: 'Универсальная',
                shedule: 0,
                structure: ['Взрослый абонемент',
                    'Детский абонемент',
                    'Читальный зал',
                    'Креатив-центр «Мы-молодые»',
                    'Центр обслуживания по подтверждению учетных записей дпользователей «Гос. Улуг»'],
                clubs: ['«Общение» - клуб досуга для пенсионеров',
